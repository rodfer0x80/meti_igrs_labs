    ...
    def ksr_request_route(self, msg):
        ...
        if (msg.Method == "INVITE"):                      
            ...
            if (KSR.pv.get("$tu") == "sip:nobody@sipnet.a"):             # To-URI for failing
                KSR.pv.sets("$ru", "sip:nobody@sipnet.terminal:9999")    # R-URI replacement to a new destination
                KSR.forward()       # Forwarding using statless mode
#                KSR.tm.t_relay()   # Forwarding using transaction mode
#                KSR.tm.t_on_failure("ksr_failure_route_INVITE")  # Definition of on_failure for INVITE
                return 1                
