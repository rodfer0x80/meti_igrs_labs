...
class kamailio:
    ...
    def ksr_request_route(self, msg):
        ...
        if (msg.Method == "INVITE"):                      
            ...
            # Check if To domain is not sipnet.b
            if (KSR.pv.get("$td") != "sipnet.b"):
                KSR.sl.send_reply(403, "Cannot route beyond sipnet.b")
                return 1

            # Check if To domain is sipnet.b (unnecessary duplicate)
            if (KSR.pv.get("$td") == "sipnet.b"):
                # Check if registered
